<div align="center">
  ...
  <h1>Lyra Music Lyrics</h1>

  <p align="center">
    <strong>Multi-provider lyrics fetching library.</strong>
    <br />
    <em>Standalone lyrics modules powering <a href="https://github.com/shnwazdeveloper/Lyra Music">Lyra Music</a> — a high-performance, privacy-focused YouTube Music client for Android.</em>
  </p>

  <p align="center">
    <img src="https://img.shields.io/badge/Lyrics%20Sources-6-6366f1?style=for-the-badge&labelColor=1e1e2e" alt="6 Lyrics Sources" />
    <img src="https://img.shields.io/github/license/shnwazdeveloper/lyrics?style=for-the-badge&color=6366f1&labelColor=1e1e2e" alt="License" />
    ...
    <img src="https://img.shields.io/github/stars/shnwazdeveloper/lyrics?style=for-the-badge&color=6366f1&labelColor=1e1e2e&logo=github" alt="Stars" />
  </p>

  <a href="https://star-history.com/#shnwazdeveloper/lyrics&lyraMusicApp/lyraMusic&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=shnwazdeveloper/lyrics,lyraMusicApp/lyraMusic&type=Date&theme=dark" />
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=shnwazdeveloper/lyrics,lyraMusicApp/lyraMusic&type=Date" />
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=shnwazdeveloper/lyrics,lyraMusicApp/lyraMusic&type=Date" width="600" />
    </picture>
  </a>
...
This repository contains the standalone lyrics provider modules extracted from [Lyra Music](https://github.com/shnwazdeveloper/Lyra Music). Each module is a self-contained Ktor-based HTTP client for a different lyrics source, designed as pure JVM libraries with no Android dependencies — the same approach as the [core](https://github.com/shnwazdeveloper/core) submodule.
...
The diagram below shows how these lyrics modules integrate into the Lyra Music app.

```mermaid
flowchart TB
    subgraph Android["Lyra Music App (Android)"]
