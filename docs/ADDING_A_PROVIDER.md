...
lyrics/yourprovider/
├── build.gradle.kts
└── src/main/kotlin/com/shnwaz/lyramusic/lyrics/yourprovider/
    └── YourProvider.kt
```
...
**`../settings.gradle.kts`** (in the main Lyra Music repo, on the `feat/lyrics-submodule` branch):
```kotlin
include(":lyrics:yourprovider")
```

**`../app/build.gradle.kts`** (in the main Lyra Music repo):
```kotlin
...
```kotlin
package com.shnwaz.lyramusic.yourprovider
...
```
app/src/main/kotlin/com/shnwaz/lyramusic/lyrics/lyrics/YourProvider.kt
```
...
import com.shnwaz.lyramusic.yourprovider.YourProvider
...
```
lyrics/yourprovider/src/main/kotlin/com/shnwaz/lyramusic/lyrics/yourprovider/
├── YourProvider.kt
└── models/
    ├── SearchResponse.kt
    └── LyricsResponse.kt
...
| Package format: `com.shnwaz.lyramusic.<name>` | Matches existing convention |
...
4. Once merged, the main Lyra Music repo's submodule reference will be updated
