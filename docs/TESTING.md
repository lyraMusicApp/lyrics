...
```
kugou/src/test/kotlin/com/shnwaz/lyramusic/lyrics/kugou/
└── KuGouTest.kt
```
...
Tests run automatically on every PR via GitHub Actions. The CI configuration mirrors the parent Lyra Music project's JVM test setup.
